...
public class ApiToken
{
    ...
    /// <summary>Optional URL notified about messages received from partners.</summary>
    [StringLength(500)]
    public string? InboxWebhookUrl { get; set; }

    /// <summary>Optional secret used to sign webhook requests (header X-AS24Net-Signature).</summary>
    [StringLength(200)]
