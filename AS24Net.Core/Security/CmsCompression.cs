...
/// <summary>
/// CMS CompressedData with the zlib algorithm (RFC 3274), the compression of AS2 (RFC 5402).
    ...
    public static byte[] Decompress(byte[] data)
    {
        ...
        try
        {
            ...
            if (reader.ReadObjectIdentifier() != CompressedDataOid)
                throw new As2ProcessingException(As2Errors.DecompressionFailed, "The content is not a CMS CompressedData package.");
            ...
            if (algorithm != ZlibOid)
                throw new As2ProcessingException(As2Errors.DecompressionFailed,
                    $"Compression algorithm {algorithm} is not supported, only zlib.");
        ...
        {
            throw new As2ProcessingException(As2Errors.DecompressionFailed, "The compressed content could not be read: " + ex.Message, ex);
        }
        ...
        {
            throw new As2ProcessingException(As2Errors.DecompressionFailed, "The content could not be decompressed: " + ex.Message, ex);
        }
