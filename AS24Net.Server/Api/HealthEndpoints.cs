...
/// <c>/health/live</c> (the process answers), <c>/health/ready</c> (the server can work, 503 when not),
...
public static class HealthEndpoints
{
    ...
    public static void MapHealth(this WebApplication app)
    {
        ...
        // Only the state, the details name partners and certificates.
        ...
        // Counts and ages without thresholds: when a message waits too long is decided by the monitoring.
